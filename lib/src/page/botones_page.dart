...
class BotonesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: _bottomNavifationBar(context)
    );
  }
    ...
    return SafeArea(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Classify this transaction into category', style: estiloSubTitulo)
          ],
        ),
      ),
    );
  ...
  Widget _bottomNavifationBar(BuildContext context){
  ...
  Widget _botonesRedondeados(){
    return Table(
      children: [
        ...
        TableRow(
          children: [
            _crearBotonesRedondeado(Colors.blueAccent, Icons.movie_filter, 'Entretaiment'),
            _crearBotonesRedondeado(Colors.green, Icons.cloud, 'Cloud')
          ]
        ),
          TableRow(
          children: [
            _crearBotonesRedondeado(Colors.red, Icons.photo, 'Fotos'),
